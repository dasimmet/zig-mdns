...
pub fn main() !void {
    ...
    const query1 = "\x00\x00\x00\x00\x00\x03\x00\x00\x00\x00\x00\x00\x0b_googlecast\x04_tcp\x05local\x00\x00\x0c\x80\x01\x05_http\xc0\x18\x00\x0c\x80\x01\x04_smb\xc0\x18\x00\x0c\x80\x01";
    ...
    const timeout_in_s = 3;
    while (std.time.microTimestamp() - start_time < timeout_in_s * std.time.us_per_s) {
